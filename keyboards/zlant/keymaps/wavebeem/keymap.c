...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT(
    ...
    _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_LEFT , KC_DOWN , KC_RGHT , KC_DEL  ,
    _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_PGDN , KC_PGUP , KC_TAB  , _______ ,
    _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______
  ),
  ...
  [4] = LAYOUT(
    ...
    KC_CAPS , KC_MPRV , KC_MNXT , KC_MPLY , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
