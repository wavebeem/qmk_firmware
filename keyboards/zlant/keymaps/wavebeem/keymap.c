...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TAB  , KC_Q    , KC_W    , KC_E    , KC_R    , KC_T    , KC_Y    , KC_U    , KC_I    , KC_O   , KC_P     , KC_BSPC ,
		...
		KC_LCTL , KC_LALT , KC_LGUI , MO(1)   , KC_SPC  , MO(3)   , KC_SPC  , MO(2)   , KC_RGUI , KC_RALT, KC_RCTL  , MO(4)
  ),
  ...
  [3] = LAYOUT(
    _______ , KC_7    , KC_8    , KC_9    , KC_PLUS , _______ , _______ , KC_HOME , KC_UP   , KC_END  , KC_BSPC , KC_BSPC ,
    _______ , KC_4    , KC_5    , KC_6    , KC_0    , KC_HOME , KC_END  , KC_LEFT , KC_DOWN , KC_RGHT , KC_DEL  , KC_DEL  ,
    _______ , KC_1    , KC_2    , KC_3    , KC_DOT  , KC_PGDN , KC_PGUP , KC_PGDN , KC_PGUP , KC_ENT  , KC_ENT  , KC_ENT  ,
    _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______
  ),
